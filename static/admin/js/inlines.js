...
(function($) {
    ...
    $(document).ready(function() {
        ...
        $(".js-inline-admin-formset .module").hide();

        if($(".field-type select#id_type option:selected").val()==='1')
            $(".field-episodes").hide();

        $(".field-type select#id_type").change(function(){
        ...
        $(".js-inline-admin-show-or-hide-button").on('click',function () {
            $(".js-inline-admin-formset .module").toggle();
        });

        $(".js-inline-admin-add-button").on('click',function () {
            $(".js-inline-admin-formset .module").toggle();
        });
