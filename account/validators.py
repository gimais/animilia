...
blacklist = ['.htaccess', '.htpasswd', '.well-known', 'ad', 'add', 'admin', 'administration',
             ...
             'offers', 'online', 'openid', 'order', 'orders', 'overview', 'owner', 'page', 'pages', 'passwd',
             'password',
             'pay', 'payment', 'payments', 'photo', 'photos', 'plans', 'plugins', 'policies', 'policy', 'pop', 'pop3',
             'popular', 'portal', 'portfolio', 'post', 'postfix', 'postmaster', 'poweruser', 'privacy',
             'privacy-policy',
             ...
             'update', 'upgrade', 'user', 'webmaster', 'website', 'www', 'yourname', 'yourusername', 'god', 'zlib',
             'anal', 'anus',
